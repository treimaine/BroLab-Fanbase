...
async def run_test():
    ...
    try:
        ...
        # -> Try to navigate directly to an Artist dashboard route while not authenticated.
        await page.goto('http://localhost:3000/artist/dashboard', timeout=10000)
        await asyncio.sleep(3)
        

        # -> Try to navigate directly to a Fan dashboard route while not authenticated.
