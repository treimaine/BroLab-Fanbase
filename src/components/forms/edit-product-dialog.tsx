...
export function EditProductDialog({
  ...
  function handleCoverImageChange(event: React.ChangeEvent<HTMLInputElement>) {
    ...
    if (!allowedTypes.includes(file.type)) {
      setCoverImageError("Please select a valid image file (JPEG, PNG, or WebP)");
      setSelectedCoverImage(null);
      setCoverImagePreview(null);
    ...
    try {
      ...
      await onEditProduct(
        product.id,
        {
          ...
          coverImageFile: selectedCoverImage ?? undefined,
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      type="url"
                      {...field}
                      disabled={isProcessing || !!selectedCoverImage}
                    />
                  </FormControl>
                  <FormDescription>
                    {selectedCoverImage 
                ...
                {!selectedCoverImage && !coverImagePreview && (
                  <label
                    className={`
                      ...
                      rounded-lg border-2 border-dashed border-muted-foreground/25 p-6 
                ...
                {coverImagePreview && (
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-muted-foreground">
                        {selectedCoverImage?.name} ({formatFileSize(selectedCoverImage?.size ?? 0)})
                      </p>
                      <Button
                        type="button"
                        variant="ghost"
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                {!selectedFile && (
                  ...
                  >
                    <Upload
                      className={`h-8 w-8 ${watchedType ? "text-muted-foreground" : "text-muted-foreground/30"} pointer-events-none`}
                    />
                    <p
                    ...
                    {watchedType && (
                      <p className="text-xs text-muted-foreground/70 pointer-events-none">
