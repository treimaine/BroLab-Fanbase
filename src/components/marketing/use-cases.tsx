...
import { GlassCard, Highlight, Reveal, Section } from "@/components/ds";
      ...
      <div className="grid gap-16 lg:grid-cols-2 lg:items-center">
        ...
        <Reveal variants={fadeInUp}>
          <h2 className="font-serif text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-5xl lg:text-6xl">
            Monetize your <br />
            <Highlight>creative universe.</Highlight>
          </h2>
        ...
        <Reveal variants={scaleIn} className="relative">
          <GlassCard
            ...
            radius="lg"
            padding="none"
            className="bg-card/60 p-6 shadow-glow-lg backdrop-blur-2xl"
          >
            {/* Dashboard Header */}
            ...
            <div className="space-y-3">
              <p className="mb-4 text-xs font-bold uppercase tracking-widest text-muted-foreground/50">Recent Activity</p>
              {[
