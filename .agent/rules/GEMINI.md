...
> **MANDATORY:** You MUST check `.brv` (ByteRover) context before ANY implementation.

### 1. ByteRover Protocol (Priority 0)
**Before ANY implementation task:**
1. Check `.brv/context-tree/` to find relevant architectural documents.
2. Read the relevant `.md` files to understand established patterns.
3. Ensure your plan aligns with the documented architecture.

### 2. Modular Skill Loading Protocol
```
